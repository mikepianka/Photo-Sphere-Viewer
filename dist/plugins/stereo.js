...
*/
import { AbstractButton, DEFAULTS, registerButton, PSVError, CONSTANTS, utils, AbstractPlugin } from 'photo-sphere-viewer';
...
registerButton(StereoButton, 'caption:right'); // other lang strings
  ...
  _proto.__startNoSleep = function __startNoSleep() {
    ...
    if ('wakeLock' in navigator) {
      navigator.wakeLock.request('screen').then(function (wakeLock) {
        ...
        return utils.logWarn('Cannot acquire WakeLock');
      });

...
import { CONSTANTS, PSVError, utils, AbstractPlugin } from 'photo-sphere-viewer';
...
var AutorotateKeypointsPlugin = /*#__PURE__*/function (_AbstractPlugin) {
  ...
  _proto.__nextStep = function __nextStep() {
    ...
    var distance = utils.greatArcDistance(this.state.startStep, this.state.endStep);
...
export { AutorotateKeypointsPlugin };

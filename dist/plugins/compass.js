...
import { SYSTEM, CONSTANTS, AbstractPlugin, utils } from 'photo-sphere-viewer';
...
var CompassPlugin = /*#__PURE__*/function (_AbstractPlugin) {
  ...
  function CompassPlugin(psv, options) {
    ...
    _this.config.position = utils.cleanPosition(_this.config.position, 'top left');
    /**
     * @private
     */

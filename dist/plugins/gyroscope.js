...
import { AbstractButton, DEFAULTS, registerButton, CONSTANTS, utils, AbstractPlugin } from 'photo-sphere-viewer';
...
var _q1 = new Quaternion(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5)); // - PI/2 around the x-axis

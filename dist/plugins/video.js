...
import { CONSTANTS, utils, AbstractComponent, AbstractButton, DEFAULTS, registerButton, PSVError, AbstractPlugin } from 'photo-sphere-viewer';
...
var PauseOverlay = /*#__PURE__*/function (_AbstractComponent) {
  ...
  function PauseOverlay(plugin) {
    ...
    _this.psv.on(CONSTANTS.EVENTS.PANORAMA_LOADED, _assertThisInitialized(_this));

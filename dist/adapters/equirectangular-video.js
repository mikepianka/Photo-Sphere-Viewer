...
import { CONSTANTS, PSVError, AbstractAdapter, utils } from 'photo-sphere-viewer';
...
var AbstractVideoAdapter = /*#__PURE__*/function (_AbstractAdapter) {
  ...
  function AbstractVideoAdapter(psv, options) {
    ...
    _this.psv.on(CONSTANTS.EVENTS.BEFORE_RENDER, _assertThisInitialized(_this));
...
var EquirectangularVideoAdapter = /*#__PURE__*/function (_AbstractVideoAdapter) {
  ...
  _proto.createMesh = function createMesh(scale) {
    ...
    var geometry = new THREE.SphereGeometry(CONSTANTS.SPHERE_RADIUS * scale, this.SPHERE_SEGMENTS, this.SPHERE_HORIZONTAL_SEGMENTS, -Math.PI / 2).scale(-1, 1, 1);
...
export { EquirectangularVideoAdapter };

...
import { SYSTEM, utils, PSVError, CONSTANTS } from 'photo-sphere-viewer';
import { CubemapAdapter, CUBE_HASHMAP } from 'photo-sphere-viewer/dist/adapters/cubemap';
...
var CubemapTilesAdapter = /*#__PURE__*/function (_CubemapAdapter) {
  ...
  _proto.__loadTile = function __loadTile(tile, task) {
    ...
    var url = panorama.tileUrl(CUBE_HASHMAP[tile.face], col, row);
